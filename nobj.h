...
void init_vars(int no, unsigned int **props,struct nobj_meta obj_prop, unsigned int ****nvar);
void free_vars(int no, struct nobj_meta obj_prop, unsigned int ****nvar);
void display_vars_props(int obj,unsigned int***nobjs,struct nobj_meta *np);
