...
static PyObject *__pyx_pf_5evepy_4even_12set_oai_work(struct __pyx_obj_5evepy_even *__pyx_v_observation, int __pyx_v_size); /* proto */
...
static PyObject *__pyx_pw_5evepy_4even_9get_util(PyObject *__pyx_v_self, PyObject *__pyx_arg_obj) {
  ...
  assert(__pyx_arg_obj); {
    __pyx_v_obj = __Pyx_PyInt_As_int(__pyx_arg_obj); if (unlikely((__pyx_v_obj == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L3_error)
  }
 ...
 */
  ...
  __pyx_t_1 = PyFloat_FromDouble(get_obj_util(__pyx_v_obj)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 17, __pyx_L1_error)
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyInt_From_int(get_oai_work()); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pw_5evepy_4even_13set_oai_work(PyObject *__pyx_v_observation, PyObject *__pyx_arg_size) {
  ...
  assert(__pyx_arg_size); {
    __pyx_v_size = __Pyx_PyInt_As_int(__pyx_arg_size); if (unlikely((__pyx_v_size == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 20, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_5evepy_4even_12set_oai_work(struct __pyx_obj_5evepy_even *__pyx_v_observation, int __pyx_v_size) {
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyObject_Call(((PyObject *)__pyx_ptype_7cpython_5array_array), __pyx_t_1, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 21, __pyx_L1_error)
